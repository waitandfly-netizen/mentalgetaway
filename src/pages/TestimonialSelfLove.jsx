...
export default function TestimonialSelfLove() {
  const paragraphs = [
    "參加心靈假期的感覺真好，嚐到這美好滋味，深刻感覺自己是多麼的需要自由、放鬆，原來自己需要好多愛，永遠不嫌多～ 平常惰性太強，加上日子繁忙，一天一天過去，忽略好好善待自己，都要等到快枯萎了，才想起來～有很多方法可以好好愛自己。",
    "",
    "對於食材的連線印象深刻，因為以往都不知道要怎麼挑選食材，這次體驗摸一摸和它培養感情，感受它的能量，一邊感覺一邊覺得這顆蘋果真是越看越可愛，不知不覺，和它互動中，好像覺得已經吸收了它的養分……",
    "",
    "發現以前對於看不順眼、不擅長的事情，會非常抗拒討厭，這次比較能專注在自己身上，就像心輪靜心一樣，一直專注在指尖，雖然有跟這個世界連結，但最終還是回到自己往內看。 不順眼的事就像一面鏡子，回過頭來問問自己在乎的是什麼？觸發了什麼？ 不擅長的事，以前常常逃走，因為怕做不好，但今天在做菜時，身邊很多人提醒：沒關係、沒關係，再調味就好，沒熟再蒸一下就好～～給出許多的愛，我也可以這樣愛自己，包容自己。",
    "",
    ...
    <div className="min-h-screen bg-stone-50">
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden bg-emerald-900">
        ...
        >
          ...
          <p className="text-stone-200/70 text-sm mt-3 tracking-widest">2026.8月宜蘭二日放空營</p>
        </motion.div>
      </section>
