  ...
  return (
    <div className="bg-stone-50">
      ...
      <Chapter
        ...
        overlay="bg-gradient-to-b from-stone-900/40 via-stone-900/20 to-[#f5f0ea]/90"
      >
      ...
      {/* ── 2. OPENING LETTER ──────────────────────────── */}
      <section className="relative bg-[#f5f0ea] py-32 px-6">
        <div className="max-w-xl mx-auto space-y-14 text-center">
          {[
            { text: "給每一個，偷偷有點累的你。", size: "text-2xl md:text-3xl text-emerald-800 font-light" },
            { text: "「一日放空篇」是為忙碌的都市人設計的輕旅程。\n在這一天裡，我們將暫時放下手機、放下工作、放下煩惱，\n全然地投入大自然的懷抱。", size: "text-base md:text-lg text-stone-600 font-light leading-loose" },
            { text: "這不是一場需要努力的課程，\n而是一段允許自己放鬆的時光。", size: "text-lg md:text-xl text-stone-700 font-light leading-loose" },
            { text: "你可以只是單純地走路、\n單純地呼吸、單純地存在。", size: "text-xl md:text-2xl text-stone-800 font-light leading-loose" },
          ].map(({ text, size }, i) => (
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
          <FadeIn>
            <p className="text-emerald-700/80 text-xs tracking-[0.4em] uppercase mb-4">The Journey</p>
            <h2 className="text-4xl md:text-5xl font-light text-stone-800 tracking-wide leading-tight mb-8">
              走進山林，<br />讓感官甦醒
            </h2>
            <p className="text-stone-600 font-light leading-loose mb-8">
      ...
      <section className="relative bg-stone-50 py-32 px-6">
        <div className="max-w-2xl mx-auto">
          <FadeIn className="text-center mb-20">
            <p className="text-emerald-600/70 text-xs tracking-[0.4em] uppercase mb-3">Schedule</p>
                ...
                <FadeIn key={item.time} delay={i * 0.06} fromY={24}>
                  <div className="relative flex gap-8 pb-16 last:pb-0">
                    ...
                    <div className="relative z-10 flex-shrink-0 w-12 flex flex-col items-center">
                      <div className="w-3 h-3 rounded-full bg-emerald-500 border-2 border-emerald-100 mt-1" />
                    </div>
                    {/* content */}
                    <div className="flex-1 -mt-1">
                      <span className="text-emerald-600 text-xs font-medium tracking-widest">{item.time}</span>
                      <h3 className="text-stone-800 text-xl font-light mt-1 mb-2">{item.activity}</h3>
      ...
      <Chapter
        ...
        overlay="bg-gradient-to-t from-[#f5f0ea]/95 via-white/30 to-transparent"
      >
        <div className="max-w-xl mx-auto px-6 py-24 text-center">
          <FadeIn>
            <p className="text-stone-700/80 text-sm font-light leading-loose">
              當身體真實的需要被看見，<br />
              心，也會慢慢鬆開。<br /><br />
      ...
      <section className="relative bg-white py-32 px-6">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          ...
          {/* includes */}
          <FadeIn>
            <p className="text-emerald-600/70 text-xs tracking-[0.4em] uppercase mb-6">Included</p>
          ...
          {/* pricing card */}
          <FadeIn delay={0.15}>
            <div className="bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-3xl p-10 text-white shadow-xl">
              <p className="text-emerald-200/80 text-xs tracking-widest mb-3">參加費用</p>
              <p className="text-5xl font-light mb-2">NT$ 1,200</p>
              <p className="text-emerald-200/60 text-sm mb-8">/ 每人</p>

              <div className="border-t border-emerald-600/40 pt-6 mb-8">
                <p className="text-emerald-200/70 text-xs tracking-widest mb-3">近期場次</p>
      ...
      {/* ── 7. CLOSING CTA ────────────────────────────── */}
      <section className="bg-stone-100 py-24 px-6 text-center">
        <FadeIn>
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-stone-400 text-sm hover:text-stone-800 transition-colors"
          >
            ← 返回所有旅程
          </Link>
        </FadeIn>
