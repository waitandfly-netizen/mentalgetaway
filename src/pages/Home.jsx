    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-stone-100/90 font-light mb-4 tracking-widest">
            好好生活，找回心靈寧靜的綠洲
          </p>
          <div className="w-20 h-px bg-amber-200/60 mx-auto my-8" />
          <p className="text-lg text-stone-200/80 font-light max-w-2xl mx-auto leading-relaxed">
            真實、美好的旅程，是一趟快樂的出走
          </p>
