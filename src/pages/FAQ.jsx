  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        {
          q: "活動費用包含什麼？",
          a: "費用包含全程課程引導、場地、餐食（依行程而定）及保險。住宿型行程另含住宿費用。交通需自行安排，我們將提供清楚的交通指引。"
        },
        {
          q: "可以取消或更改日期嗎？",
          a: "活動前 14 天，可全額退款；活動前 7-13 天取消，收取 50% 手續費；活動前 1-6 天取消，恕不退費。※ 取消報名可選擇延用下次參加(限放空篇)，轉讓請於7日前告知。建議提早規劃以保有彈性。"
        }
      ]
    },
    {
      ...
      questions: [
        {
          q: "需要有冥想或瑜伽基礎嗎？",
          a: "完全不需要。我們的課程設計適合所有程度的參加者，包括完全沒有經驗的初學者，心靈導遊會根據參加者的狀況調整節奏。"
        },
        {
          q: "體力不好也可以參加嗎？",
          a: "當然可以。我們的活動內容都是精心挑選的，難度適中，步調緩慢。重點不在於距離或速度，而是享受過程中與自然的連結。如有特殊身體狀況，請事先告知。"
        },
    ...
    },
    {
      ...
      questions: [
        {
          q: "有特殊飲食需求可以配合嗎？",
          a: "可以的。我們提供素食選項，也可配合過敏原避免。請在報名時告知您的飲食需求，我們會盡力協助安排。"
        },
        {
          q: "住宿環境如何？",
          a: "我們精選的住宿場地都位於自然環境中，乾淨舒適。房型以雙人房或多人房為主，如需單人房請提前告知（可能需另行加價）。"
        },
        {
          q: "需要自己帶什麼？",
          a: "建議攜帶：舒適的運動服裝、防曬用品、盥洗用品、防蚊液、個人藥品、水壺、輕便外套。完整的行前準備清單將於報名確認後提供。"
        }
      ]
    },
    {
      ...
      questions: [
        {
          q: "天氣不好活動會取消嗎？",
          a: "小雨情況下活動將照常進行，並視狀況調整室內課程比例；若遇颱風或豪雨等不可抗力因素，將提前通知，並協助改期或全額退費。"
        },
        {
          q: "可以帶朋友一起參加嗎？",
