  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "如何報名參加心靈假期？",
          a: "您可以透過我們的網站聯繫表單報名，或直接透過 LINE 官方帳號與我們聯繫。報名後，我們會在 24 小時內回覆確認，並提供後續繳費資訊。"
        },
        {
          q: "活動費用包含什麼？",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: "僻靜期間真的完全不能說話嗎？",
          a: "僻靜課程會有「靜語」時段，期間我們鼓勵參加者保持寧靜，但並非強制。如有任何需要（身體不適、緊急狀況等），隨時可以與引導老師溝通。"
        }
      ]
    },
    {
      ...
      questions: [
        ...
        {
          q: "住宿環境如何？",
          a: "我們精選的住宿場地都位於自然環境中，乾淨舒適，提供基本的盥洗用品。房型以雙人房或多人房為主，如需單人房請提前告知（可能需加價）。"
        },
        {
          q: "需要自己帶什麼？",
          a: "建議攜帶：舒適的運動服裝、防曬用品、個人藥品、水壺、輕便外套。詳細的行前準備清單會在報名確認後提供給您。"
        }
      ]
    },
    {
      ...
      questions: [
        ...
        {
          q: "活動後會有後續支持嗎？",
          a: "是的。參加者可以加入我們的 LINE 社群，與其他夥伴保持聯繫。我們也會不定期舉辦線上分享會和複習課程，幫助您將所學融入日常生活。"
        }
      ]
    }
  ];
