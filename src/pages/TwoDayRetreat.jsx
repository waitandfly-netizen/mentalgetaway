        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="text-stone-600 font-light leading-loose space-y-6">
              <p>
                「二日放空營」是我們最受歡迎的旅程之一。用輕鬆度假的方式，透過兩天一夜的完整體驗，讓您有足夠的時間真正地「慢下來」。
              </p>
              <p>
                活動中，從放鬆、飲食、獨處、靜心的四個向度，讓身心重新充電，並透過心靈導遊的帶領，更深入地認識自己的身體與情緒，練習活在當下，把「好好生活」品質帶回家繼續享用。
              </p>
            </div>
          </motion.div>
        </div>
            ...
            >
              ...
              <div className="space-y-2 mb-6 border-t border-indigo-700 pt-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-indigo-200 line-through text-sm">NT$ 7,800</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-white font-medium">早鳥優惠 <span className="text-indigo-300 text-xs font-normal">（7/19前）</span></span>
                  <span className="text-white font-medium text-xl">NT$ 6,800</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-indigo-200 text-sm">學生</span>
                  <span className="text-indigo-200 font-medium">NT$ 5,500</span>
                </div>
            ...
            >
              ...
              <div className="space-y-2 mb-6 border-t border-emerald-700 pt-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-emerald-200 line-through text-sm">NT$ 7,800</span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-emerald-200 text-sm">學生</span>
                  <span className="text-emerald-200 font-medium">NT$ 5,500</span>
                </div>
